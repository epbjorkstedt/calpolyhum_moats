...
tempPlot <- ggplot() +
  geom_line(data=dplyr::filter(gfdl,depth==-deep), 
            aes(x=year,y=temp),color='red',fill='red',altempa=0.8) +
  geom_line(data=dplyr::filter(hadl,depth==-deep), 
            aes(x=year,y=temp),color='blue',fill='blue',altempa=0.8) +
  geom_line(data=dplyr::filter(ipsl,depth==-deep), 
            aes(x=year,y=temp),color='green',fill='green',altempa=0.8) +
  geom_line(data=dplyr::filter(all,depth==-deep), 
            aes(x=year,y=temp),color='black') +
  geom_line(data=dplyr::filter(gfdl,depth==-shal), 
            aes(x=year,y=temp),color='red',fill='red',altempa=0.8) +
  geom_line(data=dplyr::filter(hadl,depth==-shal), 
            aes(x=year,y=temp),color='blue',fill='blue',altempa=0.8) +
  geom_line(data=dplyr::filter(ipsl,depth==-shal), 
            aes(x=year,y=temp),color='green',fill='green',altempa=0.8) +
  geom_line(data=dplyr::filter(all,depth==-deep), 
            aes(x=year,y=temp),color='black',size=2,altempa=0.5) +
  geom_line(data=dplyr::filter(all,depth==-shal), 
            aes(x=year,y=temp),color='black',size=2,altempa=0.5) +
...
oxyPlot <- ggplot() +
  geom_line(data=dplyr::filter(gfdl,depth==-deep), 
            aes(x=year,y=oxygen),color='red',fill='red',aloxygena=0.8) +
  geom_line(data=dplyr::filter(hadl,depth==-deep), 
            aes(x=year,y=oxygen),color='blue',fill='blue',aloxygena=0.8) +
  geom_line(data=dplyr::filter(ipsl,depth==-deep), 
            aes(x=year,y=oxygen),color='green',fill='green',aloxygena=0.8) +
  geom_line(data=dplyr::filter(all,depth==-deep), 
  ...
  geom_line(data=dplyr::filter(ipsl,depth==-shal), 
            aes(x=year,y=oxygen),color='green',fill='green',aloxygena=0.8) +
  geom_line(data=dplyr::filter(all,depth==-deep), 
            aes(x=year,y=oxygen),color='black',size=2,aloxygena=0.5) +
  geom_line(data=dplyr::filter(all,depth==-shal), 
            aes(x=year,y=oxygen),color='black',size=2,aloxygena=0.5) +
  geom_smooth(data=dplyr::filter(gfdl,depth==-deep), 
...
acidPlot <- ggplot() +
  geom_line(data=dplyr::filter(gfdl,depth==-deep), 
            aes(x=year,y=pH),color='red',fill='red',alpha=0.8) +
  geom_line(data=dplyr::filter(hadl,depth==-deep), 
            aes(x=year,y=pH),color='blue',fill='blue',alpha=0.8) +
  geom_line(data=dplyr::filter(ipsl,depth==-deep), 
            aes(x=year,y=pH),color='green',fill='green',alpha=0.8) +
  geom_line(data=dplyr::filter(all,depth==-deep), 
  ...
  geom_smooth(data=dplyr::filter(ipsl,depth==-shal), 
              aes(x=year,y=pH),color='green',fill='green',alpha=0.2) +
  geom_smooth(data=dplyr::filter(all,depth==-deep), 
              aes(x=year,y=pH),color='black',size=1,alpha=0.5) +
  geom_smooth(data=dplyr::filter(all,depth==-shal), 
              aes(x=year,y=pH),color='black',size=1,alpha=0.5) 
